...
from config.mysqldb.configuration import connection, get_mysqldb_connection
...
def load_from_csv(filepath):
    ...
    L = list(
        reader)  # list() method reads from reader object which is pointing to student.csvs and returns List-of-List
